...
public class NoticeService1 {
	...
	public void createnotice(Notice1 notice, MultipartFile file1, 
		...
		if(!file3.isEmpty()) {
			...
			notice.setImage2(file3.getOriginalFilename());
		}
	...
	public void update(Notice1 notice, MultipartFile file1, 
			MultipartFile file2,MultipartFile file3) throws IOException {
		//1번이미지만 변화
		if(!file1.isEmpty()) {
			s3Service.uploadFile(file1, file1.getOriginalFilename());
